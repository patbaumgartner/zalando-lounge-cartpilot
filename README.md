...
| Browser automation | Playwright Java client + Patchright Chromium sidecar |
| Telegram | TelegramBots 10.0.0 (long polling) |
| Container image | Paketo Buildpack (`paketobuildpacks/builder-jammy-base`) |
| Architecture tests | ArchUnit 1.4.2, Taikai 1.64.0 |
