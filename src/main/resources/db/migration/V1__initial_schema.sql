...
VALUES ('Pat', 'MEN', TRUE, 250.00, 400.00, 200.00,
        'TNF,Mammut,Arc''teryx,Patagonia,Haglöfs,Marc O''Polo,Vaude,ECCO,Scarpa,Dolomite',
        'Jack Wolfskin,Columbia,Icebreaker,Helly Hansen,Smartwool,Schöffel,Odlo,Meindl,Merrell,Salewa,Lowa',
        'TNF=The North Face');
