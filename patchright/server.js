...
// binding (see https://github.com/Kaliiiiiiiiii-Vinyzu/patchright TODO list),
// so the Java application connects to this server over the Playwright wire
// protocol via BrowserType.connect(wsEndpoint).
//
